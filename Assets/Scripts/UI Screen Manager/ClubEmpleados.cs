    ...
    public class ClubEmpleados
    {
        ...
        private void CargarEmpleadosDisponibles(List<Empleado> listaEmpleadosDisponible)
        {
            ...
            if (listaEmpleadosDisponible.Count >= 5)
            {
                ...
                lblEncargadoDisponible1Salario.text = listaEmpleadosDisponible[0].Salario.ToString("N0") + " €";
                lblEncargadoDisponible2Salario.text = listaEmpleadosDisponible[1].Salario.ToString("N0") + " €";
                lblEncargadoDisponible3Salario.text = listaEmpleadosDisponible[2].Salario.ToString("N0") + " €";
                lblEncargadoDisponible4Salario.text = listaEmpleadosDisponible[3].Salario.ToString("N0") + " €";
                lblEncargadoDisponible5Salario.text = listaEmpleadosDisponible[4].Salario.ToString("N0") + " €";
            ...
            if (listaEmpleadosContratados != null)
            {
                foreach (Empleado empleado in listaEmpleadosContratados)
                {
                    if (empleado.Puesto.Equals("Segundo Entrenador"))
                    {
                        ...
                        lblSegundoEntrenadorSalario.text = empleado.Salario.ToString("N0") + " €";
                    ...
                    else if (empleado.Puesto.Equals("Delegado"))
                    {
                        ...
                        lblDelegadoSalario.text = empleado.Salario.ToString("N0") + " €";
                    ...
                    else if (empleado.Puesto.Equals("Director Técnico"))
                    {
                        ...
                        lblDirectorTecnicoSalario.text = empleado.Salario.ToString("N0") + " €";
                    ...
                    else if (empleado.Puesto.Equals("Preparador Físico"))
                    {
                        ...
                        lblPreparadorFisicoSalario.text = empleado.Salario.ToString("N0") + " €";
                    ...
                    else if (empleado.Puesto.Equals("Psicólogo"))
                    {
                        ...
                        lblPsicologoSalario.text = empleado.Salario.ToString("N0") + " €";
                    ...
                    else if (empleado.Puesto.Equals("Financiero"))
                    {
                        ...
                        lblFinancieroSalario.text = empleado.Salario.ToString("N0") + " €";
                    ...
                    else if (empleado.Puesto.Equals("Equipo Médico"))
                    {
                        ...
                        lblEquipoMedicoSalario.text = empleado.Salario.ToString("N0") + " €";
                    ...
                    else if (empleado.Puesto.Equals("Encargado Campo"))
                    {
                        ...
                        lblEncargadoCampoSalario.text = empleado.Salario.ToString("N0") + " €";
